...
ampforwp-amp-on-off:
    - default
image: images/netflix-party-nedir-nasil-kullanilir.png
categories:
    - Genel
tags:
    - netflix
...
<figure class="wp-block-image size-full">![](images/netflix-party-create-party.jpg)</figure>Uzantıyı indirdiğinize göre, arkadaşlarınız ve ailenizle birlikte şovlar ve filmler izlemeye başlayabilirsiniz. Şimdi de bu keyfe nasıl başlayacağınızı adım adım takip edebilirsiniz.
